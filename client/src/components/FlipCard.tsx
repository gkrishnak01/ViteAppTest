  ...
  return (
    <div className="flip-card h-80 perspective-1000">
      <div className="flip-card-inner relative w-full h-full">
        {/* Front */}
        <div className={`flip-card-front absolute w-full h-full bg-background/30 backdrop-blur-sm rounded-lg ${classes.border} overflow-hidden`}>
        ...
        {/* Back */}
        <div className={`flip-card-back absolute w-full h-full bg-background/80 backdrop-blur-sm rounded-lg ${classes.border} p-6 flex flex-col`}>
